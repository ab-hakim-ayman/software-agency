...
const Notice = () => {  
  ...
  const DataFetch=()=>{
    axios.get(Base_URL+"/api/civil-admin/notice/", config)
  ...
  const deleteButtonClick = (e, id) => {
    e.preventDefault()
    axios.delete(Base_URL+`/api/civil-admin/notice/${id}/`, config)
      .then(res => {
              ...
              return <>
                ...
                <td class="px-6 py-4">
                  {/* <Link to="#">
                    ...
                    <Link to={`/admin/civil/editNotice/${item?.id}/`}>
