...
const UpdateFooterSection = () => {
    ...
    const retrieveMenu = () => {
      axios.get(Base_URL+`/api/civil-admin/footer-section/${id}/`,{
        headers: {
    ...
    const handleSubmit = (e) => {
      e.preventDefault();
      try {
        axios.patch(Base_URL+'/api/civil-admin/footer-section/'+ id + '/', formData, {
          headers: {
        ...
        .then((response) =>{
          if (response.data.type === 'success') {
            navigate('/admin/civil/footer-section')
