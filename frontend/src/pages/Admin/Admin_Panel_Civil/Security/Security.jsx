...
const Security = () => {
  ...
  const DataFetch=()=>{
    axios.get(Base_URL+"/api/civil-admin/security/", config)
  ...
  const deleteButtonClick = (e, id) => {
    e.preventDefault()
    axios.delete(Base_URL+`/api/civil-admin/security/${id}/`, config)
      .then(res => {
  ...
  return (
    ...
    <div className="flex items-center justify-between">
      ...
      <Link to="/admin/civil/addSecurity">
            ...
            return <>
              ...
              <td class="px-6 py-4">
                {/* <Link to="#">
                  ...
                  <Link to={`/admin/civil/editSecurity/${item?.id}/`}>
