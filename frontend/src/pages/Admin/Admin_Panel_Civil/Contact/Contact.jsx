...
const Contact = () => {
  ...
  function DataFetch() {
    axios.get(Base_URL+"/api/civil-admin/contact/", config)
  ...
  const deleteButtonClick = (e, id) => {
    e.preventDefault()
    axios.delete(Base_URL+`/api/civil-admin/contact/${id}/`, config)
      .then(res => {
  ...
  return (
    <div className=" bg-slate-950  px-10 w-full h-full mt-12 text-white">
      <div className="flex items-center justify-between">
        ...
        {/* <Link to="/admin/civil/addContact">
      ...
      <div className="overflow-x-auto">
        <table className="table border-0 mt-10 h-[full] bg-slate-900 rounded-sm">
          ...
          <tr className="border-0 grid grid-cols-6">
              ...
              <th>
                <span className=" border-l-2  border-slate-200  pl-2">fullName</span>
              </th>
              <th>
