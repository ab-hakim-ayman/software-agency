...
const Products = () => {
  ...
  function DataFetch() {
    axios.get(Base_URL+"/api/civil-admin/product/", config)
  ...
  const deleteButtonClick = (e, id) => {
    e.preventDefault()
    axios.delete(Base_URL+`/api/civil-admin/product/${id}/`, config)
      .then(res => {
    ...
    return (
        ...
        <div className="flex items-center justify-between">
          ...
          <Link to="/admin/civil/addProducts">
              ...
              return <>
                ...
                <td class="px-6 py-4">
                  {/* <Link to="#">
                    ...
                    <Link to={`/admin/civil/editProducts/${item?.id}/`}>
