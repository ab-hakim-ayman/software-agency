...
const FeatureWork = () => {
  ...
  function DataFetch(){
    axios.get(Base_URL+"/api/civil-admin/feature-work/", config)
  ...
  const deleteButtonClick = (e, id) => {
    e.preventDefault()
    axios.delete(Base_URL+`/api/civil-admin/feature-work/${id}/`, config)
      .then(res => {
  ...
  return (
    <div className=" bg-slate-950  px-10 w-full h-full mt-12 text-white">
      <div className="flex items-center justify-between">
        ...
        <Link to="/admin/civil/addFeaturework">
              ...
              return <>
                ...
                <td class="px-6 py-4">
                  {/* <Link to="#">
                    ...
                    <Link to={`/admin/civil/editFeaturework/${item?.id}/`}>
