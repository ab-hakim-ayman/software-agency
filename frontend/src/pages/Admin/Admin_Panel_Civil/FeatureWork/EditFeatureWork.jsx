...
const EditFeatureWork = () => {
  ...
  useEffect(() => {
    axios.get(Base_URL+`/api/civil-admin/feature-work/${id}/`, config)
      .then(res => {
  ...
  const UpdateFeatureWork = (e) => {
    ...
    axios.patch(Base_URL+`/api/civil-admin/feature-work/${id}/`, data1, config)
      .then(response => {
        // console.log(response.data)
        toast.success('Featurework edited Successfully')
        setTimeout(() => {
          navigate('/admin/civil/featurework');
        }, 1000);
        })
      .catch(err => console.log(err));
  }
...
export default EditFeatureWork;
