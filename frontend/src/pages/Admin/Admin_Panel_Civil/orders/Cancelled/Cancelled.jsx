...
const Cancelled = () => {
  ...
  const totalItems = cancelledOrder.length;
  ...
  const itemsToShow = cancelledOrder.slice(startIndex, endIndex);
  
  
  const fetchData = async () => {
    try {
      await axios.get(Base_URL+'/api/civil-admin/cancelled-orders/',{
        headers: {
