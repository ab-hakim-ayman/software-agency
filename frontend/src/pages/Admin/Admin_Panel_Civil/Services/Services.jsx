...
const Services = () => {
  ...
  const DataFetch=()=>{
    axios.get(Base_URL+"/api/civil-admin/services/", config)
  ...
  const deleteButtonClick = (e, id) => {
    e.preventDefault()
    axios.delete(Base_URL+`/api/civil-admin/services/${id}/`, config)
      .then(res => {
    ...
    return (
      ...
      <div className="flex items-center justify-between">
        ...
        <Link to="/admin/civil/addServices">
              ...
              return <>
                ...
                <td class="px-6 py-4">
                  {/* <Link to="#">
                    ...
                    <Link to={`/admin/civil/editServices/${item?.id}/`}>
