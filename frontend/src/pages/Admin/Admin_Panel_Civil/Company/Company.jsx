...
const Company = () => {
  ...
  const DataFetch=()=>{
    axios.get(Base_URL+"/api/civil-admin/company/", config)
  ...
  const deleteButtonClick = (e, id) => {
    e.preventDefault()
    axios.delete(Base_URL+`/api/civil-admin/company/${id}/`, config)
      .then(res => {
