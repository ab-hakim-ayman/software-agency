...
import { AdminUnAuth } from './../../../../../Auth_Middleware/UnAuth';
  ...
  const FooterSection = () => {
    const [userToken] = useState(localStorage.getItem('DTCAdminToken'));
      ...
      const totalItems = footerSection.length;
      ...
      const itemsToShow = footerSection.slice(startIndex, endIndex);
  
      const handleDelete = (e, id,activeValue) => {
        if(window.confirm('Are you sure ?')){
            e.preventDefault();
            axios.patch(Base_URL+'/api/admin-it/footer-section/' + id + '/',{active:activeValue?true:false},{
                headers: {
      ...
      const handleUpdate = (e, id) => {
        navigate(`/admin/it/update-footer-section/${id}/`);
      };
      ...
      return (
          ...
          <div className="flex items-center justify-between">
            ...
            <Link to="/admin/it/add-footer-section">
