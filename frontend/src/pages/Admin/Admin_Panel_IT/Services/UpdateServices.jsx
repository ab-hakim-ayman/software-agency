...
const UpdateServices = () => {
  const [userToken] = useState(localStorage.getItem('DTCAdminToken'));
    ...
    const retrieveMenu = () => {
        axios.get(Base_URL+`/api/admin-it/services/${id}/`, {
          headers: {
    ...
    const handleSubmit = (e) => {
      e.preventDefault();
      try {
        axios.patch(Base_URL+'/api/admin-it/services/'+ id + '/', formData, {
          headers: {
        ...
        toast.error("Service updation failed")
      }
        ...
        <div className=" mt-8">
          <form onSubmit={handleSubmit}>
            ...
            <input
              ...
              name="path" 
              value={formData.path}
              placeholder='follow this way : /service'
              onChange={handleChange}
            />
            </div>
