    ...
    const [userToken] = useState(localStorage.getItem('DTCAdminToken'));
      ...
      const handleDelete = async (e, id,activeValue) => {
        if(window.confirm('Are you sure ?')){
            e.preventDefault();
            await axios.patch(Base_URL+'/api/admin-it/view-update-brand/' + id + '/', {active:activeValue?true:false}, {
              headers: {
      ...
      const handleUpdate = (e, id) => {
        navigate(`/admin/it/update-brand-item/${id}/`);
      };
  
      const fetchData = async () => {
        try {
          await axios.get(Base_URL+'/api/admin-it/create-view-brand/', {
            headers: {
              Authorization: 'Bearer ' + userToken
            }
          })
      ...
      return (
          ...
          <div className="flex items-center justify-between">
            ...
            <Link to="/admin/it/add-brand-item">
